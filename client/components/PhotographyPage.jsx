            ...
            {services.map((s, index) => (
              ...
              >
                ...
                <div className="relative flex justify-center mb-2">
                  <div className="absolute -top-1 -left-1 w-12 h-12 bg-coral-100 rounded-full opacity-30 filter blur-md group-hover:opacity-50 transition-opacity"></div>
                  <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-coral-500 to-primary flex items-center justify-center shadow-md relative z-10 group-hover:scale-110 transition-transform duration-300">
                ...
                <div className="relative z-10 flex flex-col flex-grow">
                  <div className="flex-shrink-0">
                    <h3 className="text-[15px] font-bold text-gray-900 mb-1.5 text-center group-hover:text-coral-600 transition-colors line-clamp-2 min-h-[2.75rem]">{s.title}</h3>
                  ...
                  <div className="space-y-1.5 flex flex-col w-full px-2 mb-2 flex-grow">
                    {s.impacts.map((impact, i) => (
                      <div key={i} className="flex items-center text-xs text-gray-700 group/item transition-all duration-300 hover:translate-x-1">
                        <span className="w-1.5 h-1.5 bg-coral-500 rounded-full mr-2 group-hover/item:scale-125 transition-transform flex-shrink-0"></span>
