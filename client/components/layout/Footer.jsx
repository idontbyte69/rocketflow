            ...
            <div className="flex space-x-4">
              {socialLinks.map((social) => (
                <a
                  key={social.name}
                  href={social.href}
                  className="text-gray-400 hover:text-coral-500 transition-colors duration-200"
              ...
              <ul className="space-y-3">
                {section.links.map((link) => (
                  <li key={link.name}>
                    <a
                      href={link.href}
                      className="text-sm text-gray-600 hover:text-coral-500 transition-colors duration-200"
                    >
                      {link.name}
                    </a>
                  </li>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex flex-col sm:flex-row gap-2 w-full md:w-auto">
              <input
                ...
                className="px-4 py-2 border border-gray-300 rounded-full text-sm focus:outline-none focus:ring-2 focus:ring-coral-500 focus:border-transparent w-full sm:w-64"
              />
        ...
        <div className="mt-8 pt-8 border-t border-gray-200">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6 text-sm text-gray-500">
              <a href="#" className="hover:text-coral-500 transition-colors duration-200">
                Privacy Policy
              </a>
              <a href="#" className="hover:text-coral-500 transition-colors duration-200">
                Terms of Service
